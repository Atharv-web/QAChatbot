...
urls = ['https://en.wikipedia.org/wiki/Prompt_engineering',
        ...
        'https://www.jrvarma.in/blog/',
        'https://www.ies.gov.in/pdfs/DOC-20240704-WA0000.pdf',
        ]
...
# this question is not in the vectorstore as vectorstore contais documents that are related to prompt engineering and fincance.
# therfore a web search will be done for this.
